...
function turnClick(square) {
  ...
  if (typeof origBoard[square.target.id] == "number") {
    //If the clicked ID is "number", it means that both human and AI have not played in that position. So.....
...
function checkWin(board, player) {
  ...
  let gameWon = null;
  /* entries: Returns the enumerable property array of [key, value] pairs with the given object, similar to using the for ... in iteration. */ for (let [
    index,
    win,
  ] of winCombos.entries()) {
